...
# pirms 251657,17.04.2015,5,6,13,20,33,3,8 ir citi html tokeni (https://www.latloto.lv/lv/arhivs/eurojackpot/9)

#### HOWTO RUN ###########################################################################################################
# Use Internet Download Manager to get all arhive result files (15) from https://www.latloto.lv/lv/arhivs/eurojackpot/1-15
# Save all files in folder "C:\Users\agrisk\Documents\Loto\Perl\RezultatuArhivs\Eurojackpot"
# edit $izlozu_skaits - cik izlozes apstradat. Taam jaabuut ieksaa nolasiitajos .htm failos
# run from cmd prompt "C:\Users\agrisk\Documents\Loto\Perl\Eurojackpot.pl"
#
#### EDIT PARAMETERS HERE #######################################################################################################
my $skaitli_diapazons = 50;   		# 50, kopejais bumbinu skaits
my $skaitli_skaits = 5;				# 5, izveleto bumbinu skaits
my $papildskaitli_diapazons = 12;   # 10, papildskaitlu diapazons
my $papildsk_skaits = 2;			# 2, papildskaitlu skaits
my $izlozu_skaits = 102; 			# cik pedejas izlozes apstradat
...
my $avg_sum = 128;  # average sum
my $lps = 95;  # lowest probable sum
my $hps = 160;  # highest probable sum
my $ls = 30;  # lowest sum (mod %10 must be zero)
my $hs = 210; # highest sum (mod %10 must be zero)
#################################################################################################################
...
my @array_partial = ();
my $book = ReadData ('../RezultatuArhivs/Eurojackpot/eurojackpot.xls');
